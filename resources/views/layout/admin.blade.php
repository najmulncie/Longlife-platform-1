             ...
             <!-- 3. Referral Commission with submenu -->
                ...
                <li>
                    <button onclick="toggleMenu('vTransferRequestSubmenu', 'vTransferRequestArrow')" class="flex items-center justify-between w-full hover:bg-blue-700 p-2 rounded">
                            ...
                            <i id="vTransferRequestArrow" class="fas fa-chevron-down rotate-down"></i>
                        </button>
                        <ul id="vTransferRequestSubmenu" class="ml-6 mt-1 space-y-1 hidden">
                            <li> 
                                <a href="{{ route('admin.voucher-transfer.requests') }}" class="flex items-center justify-between hover:bg-blue-800 p-2 rounded">  
                                    <div class="flex items-center gap-2">
                                        <i class="fas fa-hourglass-half"></i> T. Pending Request
                                    </div>
                                    <i class="fas fa-chevron-right"></i>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.activation.requests.approved') }}" class="flex items-center justify-between hover:bg-blue-800 p-2 rounded">
                                    <div class="flex items-center gap-2">
                                        <i class="fas fa-check-circle"></i> T. Approved Request
                                    </div>
                                    <i class="fas fa-chevron-right"></i>
                                </a>
                            </li>
